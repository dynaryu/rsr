...
app = build_app(
    title="IEEE 14-bus DC-OPF blackout reliability",
    ref_pf=1.1e-4,                            # Chan et al. 2024, Table 2, Scenario 1
    default_dataset=HERE.joinpath("../../../network-datasets/datasets/ieee14/v1"),
    default_out=HERE / "out",
    default_threshold=54.8,
    help_doc=__doc__,
)
