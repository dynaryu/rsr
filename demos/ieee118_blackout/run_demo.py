"""
RSR demo: IEEE 118-bus DC-OPF blackout reliability.

Estimates the probability of a system-wide blackout for the IEEE 118-bus power
...
et al. (2024), Scenario 1:
  - 304 failable components: 54 generator buses (4 states), 64 ordinary buses
    (2 states) and 186 branches (2 states);
...
app = build_app(
    title="IEEE 118-bus DC-OPF blackout reliability",
    ref_pf=1.0e-4,                            # Chan et al. 2024, Table 2, Scenario 1
    default_dataset=HERE.joinpath("../../../network-datasets/datasets/ieee118/v1"),
    default_out=HERE / "out",
    default_threshold=13.8,
    help_doc=__doc__,
)
